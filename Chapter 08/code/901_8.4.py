...
'temperature_100', 'temperature_120', 'temperature_80', 'wind_direction_100', 'wind_direction_120', 
'wind_direction_80', 'wind_speed_100','wind_speed_120', 'wind_speed_80','pressure_200','pressure_100','pressure_0',                                                        'power_output_80','power_output_100','power_output_120'])
...
for message in consumer:
    ...
    print(df.tail(1))
#Invoke Predict function to pass the dataframe, features, model, scaler and thresholds. This will predict and return the threshold alert.
alerts = predict_threshold(df, features, model, scaler, thresholds)
for alert in alerts:
    print(alert)
